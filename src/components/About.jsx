    ...
    <div className="grid md:grid-cols-3 gap-8">
      ...
      <aside className="border border-slate-200 dark:border-slate-800 rounded-xl p-4">
        ...
        <div className="mt-3 flex flex-col gap-2">
          <a className="hover:text-sky-600" href="https://github.com/">GitHub</a>
          <a className="hover:text-sky-600" href="https://www.linkedin.com/">LinkedIn</a>
          <a className="hover:text-sky-600" href="mailto:you@example.com">you@example.com</a>
        </div>
      </aside>
    </div>
  );
